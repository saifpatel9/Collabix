...
# Always load env from project root first (Collabix/.env), then fallback to backend/.env.
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("MYSQL_DATABASE", "collabix"),
        "USER": os.getenv("MYSQL_USER", "collabix"),
        "PASSWORD": os.getenv("MYSQL_PASSWORD", "collabix"),
