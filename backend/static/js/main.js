    ...
    if (donut) {
        new Chart(donut, {
            ...
            data: {
                ...
                datasets: [
                    { data: [58, 30, 12], backgroundColor: ["#10b981", "#3b82f6", "#ef4444"] },
                ],
            },
    ...
    if (bar) {
        new Chart(bar, {
            ...
            data: {
                labels: ["W1", "W2", "W3", "W4"],
                datasets: [
                    { data: [72, 76, 84, 89], backgroundColor: "#14b8a6", borderRadius: 10 },
                ],
            },
            options: {
                plugins: { legend: { display: false } },
...
function setupTableFeatures() {
    ...
    const render = () => {
        ...
        list.slice((page - 1) * pageSize, page * pageSize).forEach((r) => {
            r.style.display = "";
        });
...
function setupNotifications() {
    ...
    container.innerHTML = notifications
        .map((n) => `<a class="dropdown-item" href="#">${n}</a>`)
        .join("");
}
